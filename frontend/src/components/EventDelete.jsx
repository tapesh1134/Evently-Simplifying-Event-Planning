        ...
        <div className="flex flex-col gap-6">
            {loading ? (
                ...
                eventsToShow.map((event) => (
                    ...
                    >
                        <img
                            src={event.image?.url || "/default-image.jpg"}
                        ...
                        <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                            <Link
                                ...
                                className="flex-1 bg-gradient-to-r from-blue-500 to-teal-500 text-white py-4 px-6 text-center rounded-full shadow-md transform transition duration-300 ease-in-out hover:scale-105 hover:from-blue-600 hover:to-teal-600 focus:outline-none focus:ring-2 focus:ring-blue-400"
                            >
                                View
                            </Link>
                            <button
                                className="flex-1 bg-gradient-to-r from-red-500 to-pink-500 text-white py-4 px-6 text-center rounded-full shadow-md transform transition duration-300 ease-in-out hover:scale-105 hover:from-red-600 hover:to-pink-600 focus:outline-none focus:ring-2 focus:ring-red-400"
